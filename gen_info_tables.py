...
def nut_supplements(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif nut_supplements == "Data not available":
            nut_supplements = "Data not available"
            nuts = ("Data not available",) * 3
...
def phys_act(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif phys_act == "Data not available":
            phys_act, phys_act_done, phys_act_freq = ("Data not available",) * 3
...
def med_history(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif medical_history_y_n == "Data not available":
            medical_history_y_n = "Data not available"
            med_hist = ("Data not available",) * 3
...
def cancer_history(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif previous_cancer_history_y_n == "Data not available":
            previous_cancer_history_y_n = "Data not available"
            previous_cancer = ("Data not available",) * 5
...
def family_details(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif siblings == "Data not available":
            siblings_number, sisters, brothers = ("Data not available", )*3
...
def habits(file_number):
    ...
    while not check:
        ...
        elif alcohol == "Data not available":
            alcohol_consump = "Data not available"
            alcohol_age, alcohol_quant, alcohol_duration, alcohol_comments = ("Data not available",) * 4
        ...
        elif tobacco == "Data not available":
            tobacco = "Data not available"
            exposure_type, tobacco_type, tobacco_passive, tobacco_age, tobacco_freq, tobacco_quant, tobacco_duration, \
            tobacco_comments = ("Data not available",) * 8
...
def family_cancer(conn, cursor, file_number):
    ...
    while not check:
        ...
        elif family_cancer_history_y_n == "Data not available":
            family_cancer_history_y_n = "Data not available"
            family_cancer = "Data not available"
