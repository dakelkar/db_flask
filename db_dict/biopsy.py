class BiopsyDict():
    ...
    consent_form_dict = {'tbd':"To be filled","Y":"Consent form with signature present in folder","N":"Completed consent form not present in folder"}
    consent_form_choice = generate_choice(consent_form_dict)
    biopsy_type_dict ={'tbd':"To be filled","direct":"Direct", "usg_guided":"USG Guided", "vab":"VAB", "truecut":"True-cut",
     "stereo":"Steriotactic", "other":"Other"}
    biopsy_type_choice = generate_choice(biopsy_type_dict)
    tumour_diagnosis_dict ={'tbd':"To be filled",'benign':'Benign','dcis_micro':"Ductal carcinoma in situ(DCIS) with microinvasion",
    ...
    lymphovascular_emboli_dict = {'tbd':"To be filled","Y": "Lymphovascular Emboli Seen","N":"No Lymphovascular Emboli Seen"}
    lymphovascular_emboli_choice = generate_choice(lymphovascular_emboli_dict)
    dcis_biopsy_dict = {'tbd':"To be filled","Y":"DCIS seen", "N": "DCIS not seen"}
    dcis_biopsy_choice = generate_choice(dcis_biopsy_dict)
    tumour_er_dict = {'tbd':"To be filled","pos":"Positive", "neg": "Negative"}
    tumour_er_choice = generate_choice(tumour_er_dict)
    tumour_pr_dict = {'tbd':"To be filled","pos":"Positive", "neg": "Negative"}
    ...
    fnac_dict = {'tbd':"To be filled","Y":"Done", "N":"Not Done"}
    ...
    fnac_diagnosis_dict = {'tbd':"To be filled","normal":"Normal", "benign":"Benign", "malignant":"Malignant","other": "Other"}
