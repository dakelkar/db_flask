...
from schema_forms.patient_details.patient_optional_forms import AlcoholConsumptionForm, TobaccoConsumption, \
    BreastSymptomsForm, CancerTreatmentOtherForm, CancerTreatmentDetailsForm
...
class PatientInformationHabitsForm(SectionForm):
    ...
    fld_tobacco_form_present = SelectField("Is there any exposure to Tobacco (Passive and/or Active)", choices=CommonDict.form_yes_no_choice)
...
class CancerTreatmentForm(BaseForm):
    fld_cancer_treatment_radiation_form_present = SelectField("Radiation treatment taken",
                                                              choices=CommonDict.form_yes_no_choice)
    cancer_treatment_radiation_form = FormField(CancerTreatmentDetailsForm)
    fld_cancer_treatment_chemotherapy_form_present = SelectField("Chemotherapy treatment taken",
                                                                 choices=CommonDict.form_yes_no_choice)
    cancer_treatment_chemotherapy_form = FormField(CancerTreatmentDetailsForm)
    fld_cancer_treatment_hormone_form_present = SelectField("Hormone treatment taken",
                                                            choices=CommonDict.form_yes_no_choice)
    cancer_treatment_hormone_form = FormField(CancerTreatmentDetailsForm)
    fld_cancer_treatment_alt_form_present = SelectField("Alternate Therapy treatment taken",
                                                    choices=CommonDict.form_yes_no_choice)
    cancer_treatment_alt_form = FormField(CancerTreatmentDetailsForm)
    fld_cancer_treatment_home_form_present = SelectField("Home Remedy treatment taken",
                                                    choices=CommonDict.form_yes_no_choice)
    cancer_treatment_home_form = FormField(CancerTreatmentDetailsForm)
    fld_cancer_treatment_other_form_present = SelectField("Other treatment taken for cancer", choices=CommonDict.form_yes_no_choice)
    cancer_treatment_other_form = FormField(CancerTreatmentOtherForm)
